...
class API {
  ...
  async getClients() {
    return this.call({
      ...
      client,
      // clientEnd: new Date(client.clientEnd),

      clientEnd: client.clientEnd,
      dataEnd: new Date(client.clientEnd),
  ...
  async createClient({ name, clientEnd }) {
    console.log('api.js  createClient  clientEnd', clientEnd)
    return this.call({
      method: 'post',
      path: '/wireguard/client',
      body: { name, clientEnd },
